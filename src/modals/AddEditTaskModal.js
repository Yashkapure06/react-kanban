    ...
    >
      ...
      >
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <button
            className=" w-full items-center dark:text-[#635fc7] dark:bg-white  text-white bg-[#f582b9] py-2 rounded-full "
            onClick={() => {
              setSubtasks((state) => [
                ...state,
                { title: "", isCompleted: false, id: uuidv4() },
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <select
            ...
            className="select select-status flex-grow px-4 py-2 rounded-md text-sm bg-transparent focus:border-0  border-[1px] border-gray-300 focus:outline-[#635fc7] outline-none"
          >
          ...
          <button
            ...
            className=" w-full items-center text-white bg-[#f582b9] py-2 rounded-full "
          >
